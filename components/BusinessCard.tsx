  ...
  return (
    <View
      style={[
        ...
        fillHeight && styles.cardOuterWrapperFill,
        compactVerticalPadding && styles.cardOuterWrapperCompactVertical,
      ]}
    >
      <TouchableOpacity
        style={[
          styles.cardWrapper,
          fillHeight && styles.cardWrapperFill,
          containerStyle,
        ]}
        onPress={onPress}
        activeOpacity={0.98}
      >
        ...
        <View
          style={[
            styles.cardInner,
            pillsAboveCard && styles.cardInnerWithPillsAbove,
            hideCardShadow && styles.cardInnerNoShadow,
          ]}
        >
                  ...
                  {(!hideRegisterButton || registerButtonGreyed) && (
                    <TouchableOpacity
                      style={[
                        ...
                        registerButtonGreyed && styles.registerButtonGreyed,
                      ]}
                      onPress={
                        registerButtonGreyed ? undefined : onRegisterPress
                      }
                      ...
                      <Text
                        style={[
                          ...
                          registerButtonGreyed &&
                            styles.registerButtonTextGreyed,
                        ]}
                      >
                        Register
                      </Text>
        ...
        <TouchableOpacity
          style={[
            styles.organizerPill,
            pillsAboveCard && styles.organizerPillAbove,
          ]}
          activeOpacity={0.8}
          onPress={(e) => {
            e?.stopPropagation?.();
        ...
        >
          ...
          <View style={styles.organizerPillText}>
            ...
            <Text style={styles.organizerTime} numberOfLines={1}>
              {timeText}
            </Text>
          </View>
        </TouchableOpacity>
          ...
          >
            <ScrollView
              ...
              onMomentumScrollEnd={(e) => {
                ...
                const index =
                  w > 0 ? Math.round(e.nativeEvent.contentOffset.x / w) : 0;
  ...
  const renderLeftActions = (progress: any, dragX: any) => {
    ...
    return (
      <View style={styles.leftActionContainer}>
        <Animated.View
          style={[styles.saveActionBtn, { transform: [{ translateX: trans }] }]}
        >
    ...
    <>
      <Swipeable
        ...
        containerStyle={[
          ...
          compactVerticalPadding && styles.swipeContainerCompact,
        ]}
